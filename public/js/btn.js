...
var checks = document.querySelectorAll('.check_service');
...
try {
  var _loop = function _loop() {
    ...
    check.addEventListener('click', function (e) {
      var attributes = check.getAttributeNames();
...
btn.addEventListener('click', function (e) {
  var checks = document.querySelectorAll('.check_service'); //console.log(checks);
  ...
  try {
    for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
      ...
      var attributes = check.getAttributeNames(); //console.log(check.getAttributeNames());

      if (attributes.includes('checked')) {
        count++; //console.log(attributes);
      }
    }
  } catch (err) {
    _iterator2.e(err);
